...
ap.add_argument("-i", "--input", type=float, default=0, help="id of the camera")
...
while cap.isOpened():
    ...
    if not ret:
        print("Can't receive frame (stream ent?). Exiting ...")
        break
    ...
    # display each frame in the window
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter(args["output"], fourcc, 12, (frame.shape[1], frame.shape[0]), True)
